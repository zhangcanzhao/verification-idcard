...
(function (root, factory) {
	...
	var checkIdcard = function(num){
        ...
        if (len == 15) {
            ...
            // 地区验证
            // 地区验证
            function vaeificaAddress(address, num){
                var isTrue = false
                for (var i = 0; i < address.length; i++){
                    if (address[i].value.substr(0,2) === num.substr(0,2)){
                        for (var j = 0; j <address[i].children.length;j++){
                            if (address[i].children[j].value.substr(2,2) === num.substr(2,2)){
                                isTrue = true
                                return isTrue
                            }else {
                                isTrue = false
            ...
            if (!bGoodDay && !vaeificaAddress(address, num)) {
